...
const ErrorPage = () => {
  ...
  return (
    <div className="w-screen h-screen flex flex-col items-center justify-center bg-gradient-to-r from-customBlue to-customBlack text-center text-white">
      ...
      <a 
        href="/" 
        className="mt-4 px-6 py-3 font-bold  bg-customBlack text-white rounded-full hover:bg-customYellow hover:text-customBlack hover:border-none transition duration-300"
